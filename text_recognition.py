...
for ((startX, startY, endX, endY), text) in results:
    ...
    text_width, text_height = retval
    new_scale = 1.0 * (endX - startX) / text_width
    thickness = int(new_scale)
    print text, new_scale
    output = cv2.putText(output, text, (startX, startY),
